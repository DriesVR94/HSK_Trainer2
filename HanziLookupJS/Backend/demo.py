...
def parse_arg():
    ...
    parser.add_argument('--image_path', type=str, default='C:/Users/Dries Van Ranst/OneDrive/Bureaublad/mai.png', help='the path to your image')
    parser.add_argument('--checkpoint', type=str, default='C:/Users/Dries Van Ranst/OneDrive/Bureaublad/VS_Code/HSK_Project/HanziLookupJS/Backend/output/checkpoints/mixed_second_finetune_acc_97P7.pth',
...
if __name__ == '__main__':
    ...
    print("File exists:", os.path.exists(args.checkpoint))
